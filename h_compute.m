...
function [h_sensor, h_pos] = h_compute(set, pos, b_box, delta, R_x,...
    Rob_sen_rads)
% the function computes the coverage value of the robots given the inputs
% INPUTS
% set : 
% pos : the position for the coverage to be checked
