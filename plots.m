...
function plots(set, t_box, delta, h_pos)
    ...
    env_x_range = t_box(1,1):delta:t_box(1,2);
    env_y_range = t_box(2,1):delta:t_box(2,2);
...
%     rectangle('Position',[obs_3x obs_3y len_3x len_3y], 'EdgeColor', 'g', 'FaceColor', 'g')
    ...
    axis([t_box(1,1) t_box(1,2) t_box(2,1) t_box(2,2)])
    axis equal
    box on
end