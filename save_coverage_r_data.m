...
%     coverage_r_data_gen;
    ...
    fprintf(readmefileid,['## This folder contains the outputs of a simulation'...
        ...
        'randomly. The team is rearranged based on \n\n']);
    ...
    csvwrite('radius_tune_range.csv', radius_tune_range);
    csvwrite('coverage.csv', coverage_out);
    csvwrite('coverage_ratio',coverage_out/base_coverage);
